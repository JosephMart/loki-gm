...
export default abstract class Handler<P, V, R = false> {
   ...
   */
  protected subHandlers: Handler<P, V>[] = [];
   ...
   * @param handler
   */
  protected register(handler: Handler<P, V>): void {
